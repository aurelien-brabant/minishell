...
static const t_token_type	g_token_type[CHR_CLASS_MAX] = {
	...
	[CHR_CLASS_BACKSLASH] = TOKEN_WORD,
	[CHR_CLASS_POUND] = TOKEN_OPERATOR,
	[CHR_CLASS_LPARENS] = TOKEN_OPERATOR,
	[CHR_CLASS_RPARENS] = TOKEN_OPERATOR,
	[CHR_CLASS_LBRACKET] = TOKEN_OPERATOR,
	[CHR_CLASS_RBRACKET] = TOKEN_OPERATOR,
	[CHR_CLASS_LBRACE] = TOKEN_OPERATOR,
	[CHR_CLASS_RBRACE] = TOKEN_OPERATOR,
	[CHR_CLASS_AND] = TOKEN_OPERATOR,
...
static const bool			g_token_rules[TOKEN_MAX][CHR_CLASS_MAX] = {
	[TOKEN_WORD] = {
		...
		[CHR_CLASS_LPARENS] = 0,
		[CHR_CLASS_RPARENS] = 0,
		[CHR_CLASS_LBRACKET] = 0,
		[CHR_CLASS_RBRACKET] = 0,
		[CHR_CLASS_LBRACE] = 0,
		[CHR_CLASS_RBRACE] = 0,
		[CHR_CLASS_AND] = 0,
	},
	[TOKEN_OPERATOR] = {
		...
		[CHR_CLASS_LPARENS] = 1,
		[CHR_CLASS_RPARENS] = 1,
		[CHR_CLASS_LBRACKET] = 1,
		[CHR_CLASS_RBRACKET] = 1,
		[CHR_CLASS_LBRACE] = 1,
		[CHR_CLASS_RBRACE] = 1,
		[CHR_CLASS_AND] = 1,
	},
