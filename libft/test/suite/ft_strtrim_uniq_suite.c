...
TestSuite(ft_strtrim_uniq);

Test(ft_strtrim_uniq, test_basic)
{
	...
	trimed = ft_strtrim_uniq(totrim, set);
	strcpy(ftbuf, trimed);
	free(trimed);
...
Test(ft_strtrim_uniq, test_empty_set)
{
	char	*ref = "Hello world";
	char	ftbuf[1000];
...
Test(ft_strtrim_uniq, test_big_trim)
{
...
Test(ft_strtrim_uniq, test_trim_uniq)
{
	char	*ref = "Hello world";
	char	ftbuf[1000];
	char	*totrim = "   eeeeeeeeeeeeeeeeeeeeeeeeeeeeHello      worldeeeeeeekkek   ";
